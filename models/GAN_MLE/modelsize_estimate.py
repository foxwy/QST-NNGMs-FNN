...
def modelsize(model, input, type_size=4):
    ...
    print('Model {} : params num: {}'.format(model._get_name(), para))
    ...
    return para, para * type_size / 1000 / 1000, total_nums * type_size / 1000 / 1000, total_nums * type_size*2 / 1000 / 1000
